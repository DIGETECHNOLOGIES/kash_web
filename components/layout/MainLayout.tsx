...
export function MainLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen flex flex-col pb-16 md:pb-0 text-text dark:text-text-dark bg-background dark:bg-background-dark transition-colors duration-300">
            <Navbar />
            ...
            <footer className="hidden md:block border-t border-border mt-12 py-12 bg-surface dark:bg-surface-dark transition-colors">
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="space-y-4">
                            <h3 className="font-bold uppercase tracking-widest text-xs opacity-60">{t('common.marketplace')}</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold uppercase tracking-widest text-xs opacity-60">{t('common.information')}</h3>
                            <ul className="space-y-2 text-sm text-text-secondary">
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold uppercase tracking-widest text-xs opacity-60">{t('common.account')}</h3>
                            <ul className="space-y-2 text-sm text-text-secondary">
                        ...
                        <div className="space-y-6">
                            <h3 className="font-bold uppercase tracking-widest text-xs opacity-60">{t('common.download')}</h3>
                            <div className="flex flex-col gap-4">
                                <button
                                    onClick={() => window.open('https://play.google.com/store/apps/details?id=com.kash.marketplace', '_blank')}
                                ...
                                <button
                                    onClick={() => window.open('https://apps.apple.com/app/kash/id6761426654', '_blank')}
                                    className="flex items-center gap-3 bg-black text-white px-6 py-3 rounded-2xl hover:bg-zinc-900 transition-all border border-zinc-800 shadow-xl group active:scale-95 text-left"
                                >
                                    <Apple className="w-6 h-6" fill="currentColor" />
                                    <div>
                                        <p className="text-[10px] font-bold opacity-60 uppercase tracking-tighter leading-none mb-0.5">Download on the</p>
                                        <p className="text-sm font-black tracking-tight leading-none uppercase italic">App Store</p>
                                    </div>
                                </button>
                            </div>
                        </div>
