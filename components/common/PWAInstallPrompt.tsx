                        ...
                        <div className="flex flex-col gap-4">
                            {platform === 'android' ? (
                                ...
                                >
                                    ...
                                    <svg viewBox="30 336.7 120.9 129.2" className="h-8 w-8 shrink-0">
                                        <path fill="#EA4335" d="M30 344.9v112.8c0 4.4 3.6 8 8 8 1.1 0 2.1-.2 3.1-.7l65.1-59.7-76.2-60.4z" />
                                        <path fill="#FBBC04" d="M110.1 405.1l36.3-33.3c3.2-2.9 4.4-7.4 3.1-11.5-1.3-4.1-5.1-7-9.4-7H38c-4.4 0-8 3.6-8 8v.2l80.1 43.6z" />
                                        <path fill="#34A853" d="M146.4 430c1.3-4.1.1-8.6-3.1-11.5l-36.3-33.3-3.1 2.8-38.9 35.7v.1c0 4.4 3.6 8 8 8h104c4.3 0 8.1-2.9 9.4-7.1z" />
                                        <path fill="#4285F4" d="M107.1 388l42.4 23.1c1.3.7 2.1 2.1 2.1 3.6 0 1.5-.8 2.9-2.1 3.6l-42.4 23.1-4.8-4.4 3.7-3.4 31.7-29-31.7-29-3.7-3.4 4.8-4.2z" />
                                    </svg>
