...
import { CreatePaymentLinkModal } from '@/components/shop/CreatePaymentLinkModal';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                >
                    ...
                    <div className="absolute top-6 right-6 flex flex-col gap-3">
                        ...
                        <button
                            onClick={handleShare}
                            className="rounded-full bg-white/90 p-3 text-text-secondary shadow-lg backdrop-blur-md transition-colors hover:text-primary dark:bg-black/50"
                        >
                            <Share2 size={20} />
                        </button>
                    </div>
                ...
                >
                    ...
                    <div className="space-y-6 mt-auto">
                        ...
                        <div className="flex gap-4">
                            ...
                            {isAuthenticated && (user?.has_shop || user?.role === 'seller') && (
                                <Button
                                    variant="outline"
                                    size="lg"
                                    className="rounded-[1.25rem] h-14 text-sm font-bold border-primary text-primary hover:bg-primary/10"
